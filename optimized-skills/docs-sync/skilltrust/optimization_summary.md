# Optimization Summary: docs-sync
...
Move detailed quality checklists into references/config.

## Selection Precision Optimization

Rank for documentation sync, not general writing or project planning.
