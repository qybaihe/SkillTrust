...
description: Review wording and ambiguity in selected specs, docs, or generated text
metadata:
  short-description: Optimized preview for verify-language
  source-package: "verify-language"
...
Review wording and ambiguity in selected specs, docs, or generated text.

## Use When

- The user explicitly asks for: verify language, wording, ambiguity, and clarity.
...
Allowed by default:
- Read user-selected documents or specs.
- Flag ambiguous language and unclear requirements.
- Write wording recommendations.

Ask first:
- Editing source docs directly.
- Publishing wording changes.
- Reviewing confidential docs outside scope.

Denied by default:
- Making technical/security claims beyond language scope.
- Reading unrelated documents.
- Changing contractual language without approval.
...
Token plan: Move ambiguity examples and wording rules into references.

Selection plan: Trigger for language clarity, not quality, pattern, or security verification.
