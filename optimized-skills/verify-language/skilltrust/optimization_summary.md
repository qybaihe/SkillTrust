# Optimization Summary: verify-language
...
Move ambiguity examples and wording rules into references.

## Selection Precision Optimization

Trigger for language clarity, not quality, pattern, or security verification.
