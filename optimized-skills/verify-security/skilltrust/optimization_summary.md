# Optimization Summary: verify-security
...
Move deterministic red-lines and severity schemas into validators.

## Selection Precision Optimization

Trigger for security verification, not general quality, language, or pattern review.
