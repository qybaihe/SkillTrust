# Optimization Summary: compliance-checker
...
Move compliance matrices and checklists into references/schemas.

## Selection Precision Optimization

Rank for compliance assessment, not incident response or general security scanning.
