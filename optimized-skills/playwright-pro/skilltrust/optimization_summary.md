# Optimization Summary: playwright-pro
...
Move command catalogs and integration setup into references/scripts.

## Selection Precision Optimization

Rank for Playwright-specific test tasks, not all browser automation.
