# Optimization Summary: saving-workspace-context
...
Move routing rules and memory schema into config.

## Selection Precision Optimization

Rank for workspace-memory tasks, not project switching or documentation sync.
