# Optimization Summary: ms365-tenant-manager
...
Move PowerShell templates and troubleshooting into references/scripts.

## Selection Precision Optimization

Rank for explicit M365 tenant administration, not generic cloud or compliance tasks.
