# Optimization Summary: senior-architect
...
Move pattern libraries and decision frameworks into references.

## Selection Precision Optimization

Rank for architecture/design tasks, not code review or project planning.
