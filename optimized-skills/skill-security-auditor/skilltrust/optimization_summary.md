# Optimization Summary: skill-security-auditor
...
Move threat model examples and attack-string catalogs into references.

## Selection Precision Optimization

Rank for Skill security audits, not general code review or policy writing.
