# Optimization Summary: code-review-pro
...
Move review rubrics and examples into references.

## Selection Precision Optimization

Rank for code review, not architecture design or security-only audits.
