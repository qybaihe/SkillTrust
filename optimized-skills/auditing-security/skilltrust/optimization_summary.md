# Optimization Summary: auditing-security
...
Move deterministic audit checklists into validators/scripts.

## Selection Precision Optimization

Rank for codebase security audit, not Skill package audit or compliance-only review.
