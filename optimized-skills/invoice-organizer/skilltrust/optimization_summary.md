# Optimization Summary: invoice-organizer
...
Move extraction schemas, naming rules, and checklist logic into config/validators.

## Selection Precision Optimization

Trigger only for invoice organization and metadata extraction, not broad finance advice.
