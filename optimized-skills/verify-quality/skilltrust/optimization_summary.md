# Optimization Summary: verify-quality
...
Move quality criteria and report schema into references/config.

## Selection Precision Optimization

Trigger for quality/readiness verification, not security or language-only review.
