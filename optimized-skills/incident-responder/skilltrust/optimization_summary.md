# Optimization Summary: incident-responder
...
Move response playbooks and communication templates into references.

## Selection Precision Optimization

Rank for declared incident response, not generic debugging or compliance.
